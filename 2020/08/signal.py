...
def get_accumulator_value(data, data_index, visited_indexes, acc_sum, iterator_index = 0):
...
def jmp_to_nop(data, iteration = None):
    ...
    for found_index in indexes_of_changable_elements:
        ...
        try:
            get_accumulator_value(new_data, 0, [], 0, iteration)
        except IndexError:
            break
        except Exception:
            pass
